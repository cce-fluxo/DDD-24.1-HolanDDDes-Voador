...
const HeaderLoginCadastro = () => {
  return (
    <header className="bg-branco flex fixed w-screen items-center justify-between px-16 font-poppins font-medium text-preto border-b border-cinza-2 h-24 z-50">
      <div>
        <Link href={"./"}>
