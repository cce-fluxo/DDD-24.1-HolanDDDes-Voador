...
const Perfil = () => {
  ...
  const links = [{ href: "/salvar alterações", label: "Salvar Alterações" }];
          ...
          <div className="md:w-1/3 lg:w-2/3 xl:w-1/3 mt-8 mb-6 flex flex-col items-center justify-center bg-cinza-0 rounded-[20px] ">
            <div className="md:shrink-0 flex flex-col items-center md:w-[570px] h-auto">
              <Image
                ...
                width={359.86}
                height={267.47}
                className="inline mb-4 md:h-full md:w-80"
                alt="Upload"
              />
              <h4 className="text-2xl font-medium leading-[36px] font-poppins text-preto mb-4">
                Fotos
              </h4>
                ...
                <ul className="space-y-4">
                  <li className="flex gap-2 mb-4">
                    ...
                    <span className="text-base font-normal leading-6 font-poppins text-preto">
                      Vamos começar com a foto principal! Com postura formal e
                      rosto bem aparente.
                    </span>
                  </li>
                  <li className="flex gap-2 mb-4">
                    ...
                    ></span>
                    <span className="text-base font-normal leading-6 font-poppins text-preto">
                      Que tal uma foto mais descontraída? Experimente postar uma
                      foto sua praticando algum hobby!
                    </span>
                  </li>
                  <li className="flex gap-2">
                    ...
                    ></span>
                    <span className="text-base font-normal leading-6 font-poppins text-preto">
                      Por último, seria interessante uma foto sua com algum ente
                      querido. Seja um amigo, familiar, ou com seu pet!
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="w-full md:max-w-2xl  flex flex-col items-center justify-center mt-8 px-4">
            <div className="border-2 border-dashed border-cinza-2 w-full max-w-2xl  h-[450px] rounded-[10px] flex items-center justify-center mb-5 p-8">
              <Image
                ...
                className="hover:content-[url('/image_hover.png')]"
              />
              <input
                type="file"
                ref={fileInputRef}
            ...
            <button
              onClick={openModal}
              className="mt-5 mb-5 py-6 px-[20px] bg-rosa-4 text-white w-[340px] h-[57px] flex items-center justify-around gap-[10px] font-poppins text-2xl font-normal rounded-[10px] leading-9  hover:bg-rosa-3 -tracking-2"
            >
              Salvar Alterações
            </button>
