...
import LogOffHeader from "@/app/HeaderLogOff";
        ...
        <div className=" w-screen justify-center gap-[13vw] items-center h-screen flex">
            <div className=" mt-10 w-[447px] h-[390px]">
                ...
                <div className=" mb-[72px] ">
                    <p className=" text-[48px] font-semibold font-poppins text-preto">Anunciar seu hotel com a <span className=" text-red-600">BonVoyage</span></p>
                    <p className=" text-[48px] font-semibold font-poppins text-preto">é <span className=" text-orange-500">Fácil</span></p>
                </div>
