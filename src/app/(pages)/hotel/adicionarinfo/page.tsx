...
const HotelSchema = Yup.object().shape({
  ...
  telefone: Yup.string()
    ...
    .matches(/^\d{2}\s\d{4,5}-\d{4}$/, 'Telefone inválido. Use o formato XX XXXXX-XXXX ou XX XXXX-XXXX.'),
  sobre: Yup.string()
    .max(500, 'Descrição não pode ter mais de 500 palavras.')
    .test('word-count', 'Descrição não pode ter mais de 500 palavras.', value => {
                ...
                >
                  {({ isSubmitting, isValid }) => (
                    <Form>
                      {/* Campo de descrição */}
                      <div className="ml-8">
                        <label htmlFor='sobre' className="w-[245px] h-[66px] font-poppins text-preto text-[24px] font-medium leading-[66px]">Descrição</label>
                        <Field 
                          as="textarea" 
                          name="sobre"
                      ...
                      <ErrorMessage name="sobre" component="div" className="text-red-500" />
                      ...
                      <div>
                        ...
                        {/*Campo de endereço */}
                        <div className="relative w-full peer h-10 border border-cinza-3 rounded-[18px] px-4 placeholder-transparent flex items-center mt-10">
                        <label htmlFor='endereco' className="font-poppins text-preto text-[24px] font-medium leading-[66px]">Endereço</label>
                        <Field 
                          type="text" 
                          name="endereco" 
                          className="ml-2 w-full h-full border-none bg-transparent font-poppins font-normal text-cinza-2 text-[24px] no-border focus:outline-none focus:text-preto"
                        ...
                        <ErrorMessage name="endereco" component="div" className="text-red-500" />
                        ...
                        <ErrorMessage name="telefone" component="div" className="text-red-500" />
